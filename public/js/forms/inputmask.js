...
class InputMask {
  ...
  _initMaskInMask() {
    if (document.querySelector('#maskCurrency')) {
      const mask = IMask(document.querySelector('#maskCurrency'), {
        mask: 'Rp num',
        blocks: {
          num: {
            mask: Number,
  ...
  _initMaskValueLog() {
    if (document.getElementById('currency')) {
      const mask = IMask(document.getElementById('currency'), {
        mask: 'Rp num',
        blocks: {
          num: {
            mask: Number,
      ...
      document.getElementById('currency').setAttribute('mask', mask);
