            ...
            <div class="col-12 col-xl-4 col-xxl-3">
                <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="text-small text-muted">Available for freelance work</div>
                                                </div>
                                                <div class="d-flex">
                                                    <button type="button" class="btn btn-outline-primary btn-sm ms-1">Hire</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-xl-12">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <button class="btn btn-sm btn-icon btn-icon-end btn-outline-muted mb-1 me-1" type="button">
                                    <span>Food (12)</span>
                                </button>
                                <button class="btn btn-sm btn-icon btn-icon-end btn-outline-muted mb-1 me-1" type="button">
                                    <span>Baking (3)</span>
