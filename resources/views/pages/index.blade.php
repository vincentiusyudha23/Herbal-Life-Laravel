            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        <div class="col-auto">
                            <i data-acorn-icon="lock-on" class="text-primary"></i>
                        </div>
                        <div class="col">
                            <a href="/Pages/Authentication" class="heading stretched-link d-block">Authentication</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Blog" class="heading stretched-link d-block">Blog</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Miscellaneous" class="heading stretched-link d-block">Miscellaneous</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Portfolio" class="heading stretched-link d-block">Portfolio</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Profile" class="heading stretched-link d-block">Profile</a>
