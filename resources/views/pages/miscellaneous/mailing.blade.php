...
@section('content')
    <div class="container">
        ...
        <div class="card mb-5">
            <div class="card-body">
                <p class="mb-2">
                    Mailing templates use inline styling and table layout to be displayed well at various service providers. To prevent the template inheriting some
                    styles from the project stylesheets, we included it as an iframe. You may use below button to view standalone version.
                </p>
                <a class="btn btn-primary" target="_blank" href="/Pages/Miscellaneous/MailingStandalone">Standalone Version</a>
            </div>
        </div>
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            <div class="pb-7" style="max-width: 600px; margin-bottom: 100px">
                <div class="card mb-5">
                    <div class="card-body">
                        <img src="/img/logo/logo-blue-light.svg" class="sw-16 mb-7" alt="logo" />
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                sesame snaps chocolate. Lollipop sweet roll sesame snaps powder. Wafer halvah chocolate soufflé icing.
                            </p>
                            <h6 class="mb-3 mt-5 heading">Muffin Sweet Roll Apple Pie</h6>
                            <p>
            ...
            <div class="pb-7" style="max-width: 600px; margin-bottom: 100px">
                <div style="max-width: 600px">
                    <div>
                        <img src="/img/logo/logo-blue-light.svg" class="sw-16 mb-5" alt="logo" />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 h-auto sh-sm-17">
                            <div class="col-12 col-sm-auto">
                                <img src="/img/product/small/product-10.webp" alt="product image 1" class="card-img card-img-horizontal-sm sh-sm-17 sw-sm-19" />
                            </div>
                                    ...
                                    <div class="row g-0 h-100 align-content-start">
                                        <a href="#" class="col-12 d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
                                            ...
                                            <div class="text-medium text-alternate mb-1">
                                                Toffee icing cupcake halvah tart. Marshmallow oat cake lemon drops chocolate bonbon powder.
                                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 h-auto sh-sm-17">
                            <div class="col-12 col-sm-auto position-relative">
                                ...
                                <img src="/img/product/small/product-6.webp" alt="product image 2" class="card-img card-img-horizontal-sm sh-25 sh-sm-17 sw-sm-19" />
                            </div>
                            <div class="col-12 col-sm">
                                <div class="card-body h-100">
                                    <div class="row g-0 h-100 align-content-start">
                                        <a href="#" class="col-12 d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
                                            ...
                                            <div class="text-medium text-alternate mb-1">
                                                Macaroon muffin apple pie tiramisu. Topping brownie pastry. Tootsie roll tootsie roll.
                                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 h-auto sh-sm-17">
                            <div class="col-12 col-sm-auto">
                                <img src="/img/product/small/product-4.webp" alt="product image 3" class="card-img card-img-horizontal-sm sh-25 sh-sm-17 sw-sm-19" />
                            </div>
                            <div class="col-12 col-sm">
                                <div class="card-body h-100">
                                    <div class="row g-0 h-100 align-content-start">
                                        <a href="#" class="col-12 d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
                                            ...
                                            <div class="text-medium text-alternate mb-1">
                                                Sweet roll soufflé candy jelly wafer cake drops. Pastry chocolate jujubes dessert.
                                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="row g-0 h-auto sh-sm-17">
                            <div class="col-12 col-sm-auto">
                                <img src="/img/product/small/product-2.webp" alt="product image 4" class="card-img card-img-horizontal-sm sh-25 sh-sm-17 sw-sm-19" />
                            </div>
                            <div class="col-12 col-sm">
                                <div class="card-body h-100">
                                    <div class="row g-0 h-100 align-content-start">
                                        <a href="#" class="col-12 d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
                                            ...
                                            <div class="text-medium text-alternate mb-1">
                                                Drops chocolate bonbon powder drops chocolate. Danish tiramisu roll dessert soufflé.
                                            </div>
            ...
            <div style="max-width: 600px">
                <div style="max-width: 600px">
                    <div class="">
                        <img src="/img/logo/logo-blue-light.svg" alt="logo" class="sw-16 mb-5" />
                    </div>
                    <div class="mb-5">
                        <p class="text-alternate">
                    ...
                    <div class="card mb-3">
                        <a href="#">
                            <img src="/img/product/large/product-1.webp" class="card-img-top sh-25" alt="card image" />
                        </a>
                        <div class="card-body">
                            <h5 class="mb-3">
                    ...
                    <div class="card mb-3">
                        <a href="#">
                            <img src="/img/product/large/product-2.webp" class="card-img-top sh-25" alt="card image" />
                        </a>
                        <div class="card-body">
                            <h5 class="mb-3">
                    ...
                    <div class="card mb-3">
                        <a href="#">
                            <img src="/img/product/large/product-3.webp" class="card-img-top sh-25" alt="card image" />
                        </a>
                        <div class="card-body">
                            <h5 class="mb-3">
