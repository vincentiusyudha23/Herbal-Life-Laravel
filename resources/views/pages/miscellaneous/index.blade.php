        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-3 g-2">
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        <div class="col-auto">
                            <i data-acorn-icon="alarm" class="text-primary"></i>
                        </div>
                        <div class="col">
                            <a href="/Pages/Miscellaneous/ComingSoon" class="heading stretched-link d-block">Coming Soon</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Empty" class="heading stretched-link d-block">Empty</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Error" class="heading stretched-link d-block">Error</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        <div class="col-auto">
                            <i data-acorn-icon="help" class="text-primary"></i>
                        </div>
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Faq" class="heading stretched-link d-block">Faq</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        <div class="col-auto">
                            <i data-acorn-icon="notebook-1" class="text-primary"></i>
                        </div>
                        <div class="col">
                            <a href="/Pages/Miscellaneous/KnowledgeBase" class="heading stretched-link d-block">Knowledge Base</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Mailing" class="heading stretched-link d-block">Mailing</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Pricing" class="heading stretched-link d-block">Pricing</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        <div class="col-auto">
                            <i data-acorn-icon="search" class="text-primary"></i>
                        </div>
                        <div class="col">
                            <a href="/Pages/Miscellaneous/Search" class="heading stretched-link d-block">Search</a>
