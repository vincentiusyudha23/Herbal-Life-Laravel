            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-md-6 col-lg d-flex align-items-start justify-content-start order-3 order-md-2">
                    <div class="btn-group me-1 check-all-container-checkbox-click" id="checkAllButton">
                        <div class="btn btn-outline-primary btn-custom-control p-0 ps-3 pe-2" data-target="#emailListContainer">
                ...
                <div id="emailCorrespondenceContainer" class="d-none">
                        ...
                        <div class="col-12 col-sm-auto">
                            <div class="row g-0">
                                <div class="col-auto order-1 order-sm-0 mx-3">
                                    <i data-acorn-icon="bell" class="text-muted"></i>
                                    <i data-acorn-icon="star" class="text-muted"></i>
                                </div>
                    ...
                    <div class="mt-5 d-none" id="detailBottomButtons">
                        ...
                        <button class="btn btn-icon btn-icon-end btn-foreground hover-outline shadow mb-1 me-1" type="button" id="forwardButton">
                            <span>Forward</span>
                            <i data-acorn-icon="arrow-top-right"></i>
                        </button>
                        <button
                    ...
                    <div class="card mt-5 d-none" id="replyEmailForm">
                        <div class="card-body">
                            <div class="mb-3 filled w-100">
                                ...
                                <input id="replyEmailAddress" name="tagsFilled" placeholder="" value="ollihawkins@msn.com" />
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="emailMoveContent" data-move-target="#emailColumn" data-move-breakpoint="lg">
                            <div class="menu-items">
                                ...
                                >
                                    <i data-acorn-icon="star" data-acorn-size="17" class="me-2"></i>
                                ...
                                >
                                    <i data-acorn-icon="bell" data-acorn-size="17" class="me-2"></i>
                                ...
                                >
                                    <i data-acorn-icon="send" data-acorn-size="17" class="me-2"></i>
                                ...
                                >
                                    <i data-acorn-icon="error-hexagon" data-acorn-size="17" class="me-2"></i>
                                ...
                                >
                                    <i data-acorn-icon="bin" data-acorn-size="17" class="me-2"></i>
