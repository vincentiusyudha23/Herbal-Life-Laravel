                    ...
                    <section class="scroll-section" id="basic">
                        ...
                        <div class="card mb-5">
                            <a href="/img/product/large/product-1.webp" class="lightbox">
                                <img src="/img/product/large/product-1.webp" class="card-img-top sh-50" alt="card image" />
                            </a>
                            <div class="card-body">
                    ...
                    <section class="scroll-section" id="video">
                        ...
                        <div class="card mb-5">
                            <div class="card-img-top">
                                <video id="videoPlayer" class="player" poster="/img/product/large/product-2.webp">
                            ...
                            <div class="">
                                <div class="row g-0 align-items-center">
                                    <div class="col-12 col-md-4">
                                        <img
                                                src="/img/banner/cta-vertical-2.webp"
                                    ...
                                    <div class="col-12 col-md-8 ps-md-3 ps-0">
                                        <div class="card-body">
                                            ...
                                            <p>
                                                Toffee croissant icing toffee. Sweet roll chupa chups marshmallow muffin liquorice chupa chups soufflé bonbon. Liquorice gummi
                                                bears cake donut chocolate lollipop gummi bears. Cotton candy cupcake ice cream gummies dessert muffin chocolate jelly. Danish
                                                brownie chocolate bar lollipop cookie tootsie roll candy canes. Jujubes lollipop cheesecake gummi bears cheesecake. Cake jujubes
                                                soufflé.
                                            </p>
                                            <p>
                                                Cake chocolate bar biscuit sweet roll liquorice jelly jujubes. Gingerbread icing macaroon bear claw jelly toffee. Chocolate cake
