...
@section('js_page')
    <script src="/js/pages/blocks.stats.js"></script>
@endsection
                ...
                <div>
                    ...
                    <section class="scroll-section" id="vertical">
                        ...
                        <div class="row g-2">
                            <div class="col-auto mb-5">
                                <div class="card hover-border-primary sw-19 sh-30">
                                    <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                        ...
                                        <div class="heading text-center mb-0 sh-8 d-flex align-items-center lh-1-25">Completed Orders</div>
                            ...
                            <div class="col-auto mb-5">
                                <div class="card sw-19 sh-30 bg-gradient-light">
                                    <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                        <div class="border border-foreground sw-8 sh-8 rounded-xl d-flex justify-content-center align-items-center">
                                            <i data-acorn-icon="loaf" class="text-white"></i>
                                        </div>
                                        <div class="heading text-center mb-0 sh-8 d-flex align-items-center lh-1-25 text-white">Completed Orders</div>
                    ...
                    <section class="scroll-section" id="square">
                        ...
                        <div class="row g-2">
                            <div class="col-auto mb-5">
                                <div class="card hover-border-primary sh-20 sw-20">
                                    <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                        ...
                                        <div class="heading text-center mb-0 sh-4 d-flex align-items-center lh-1">Corn</div>
                            ...
                            <div class="col-auto mb-5">
                                <div class="card sh-20 sw-20 bg-gradient-light">
                                    <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                        <div class="border border-foreground sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center">
                                            <i data-acorn-icon="loaf" class="text-white"></i>
                                        </div>
                                        <div class="heading text-center mb-0 sh-4 d-flex align-items-center lh-1 text-white">Corn</div>
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card hover-border-primary">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="heading mb-0 sh-8 d-flex align-items-center lh-1-25 ps-3">Completed Orders</div>
                                        </div>
                            ...
                            <div class="col-12 col-xl-4 mb-5">
                                <div class="card bg-gradient-light">
                                    <div class="h-100 row g-0 card-body align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="heading mb-0 sh-8 d-flex align-items-center lh-1-25 ps-3 text-white">Completed Orders</div>
                                        </div>
                                        <div class="col-auto ps-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-0 align-items-center mb-2 sh-6">
                                            ...
                                            <div class="col ps-3">
                                                <div class="row g-0">
                                                    <div class="col">
                                                        <div class="sh-3 d-flex align-items-center lh-1-25">Ingredients</div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="cta-3 text-primary sh-3 d-flex align-items-center">30%</div>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                                    <div class="col sh-1">
                                        ...
                                        <div class="row g-0 align-items-center mb-2 sh-6">
                                            ...
                                            <div class="col ps-3">
                                                <div class="row g-0">
                                                    <div class="col">
                                                        <div class="sh-3 d-flex align-items-center lh-1-25">Workers</div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="cta-3 text-primary sh-3 d-flex align-items-center">20%</div>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                                    <div class="col sh-1">
                                        ...
                                        <div class="row g-0 align-items-center mb-2 sh-6">
                                            ...
                                            <div class="col ps-3">
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="cta-3 text-primary sh-3 d-flex align-items-center">15%</div>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                                    <div class="col sh-1">
                                        ...
                                        <div class="row g-0 align-items-center mb-2 sh-6">
                                            ...
                                            <div class="col ps-3">
                                                <div class="row g-0">
                                                    <div class="col">
                                                        <div class="sh-3 d-flex align-items-center lh-1-25">Utilities</div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <div class="cta-3 text-primary sh-3 d-flex align-items-center">10%</div>
                                                    </div>
                                                </div>
                                                <div class="row g-0">
                                                    <div class="col sh-1">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="heading d-flex justify-content-between lh-1-25 mb-3">
                                            <span>Orders</span>
                                            <i data-acorn-icon="archive" class="text-primary"></i>
                                        </div>
                            ...
                            <div class="col-12 col-lg-4 col-xxl-2 mb-5">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="heading d-flex justify-content-between lh-1-25 mb-3">
                                            <span>Views</span>
                                            <i data-acorn-icon="trend-up" class="text-primary"></i>
                                        </div>
                                        <div class="text-small text-muted mb-1">THIS MONTH</div>
                                        <div class="cta-1 text-primary">1.325</div>
                                    </div>
                                        ...
                                        <div class="row g-0 mb-n5 mb-sm-0">
                                            <div class="col-6 col-sm-3 text-center d-flex justify-content-center align-items-center flex-column mb-4 mb-sm-0">
                                                <div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-3">
                                                    <i data-acorn-icon="archive" class="text-white"></i>
                                                </div>
                                                <div class="text-small text-muted mb-1">SALES</div>
                                                <div class="cta-2 text-primary">235</div>
                                            </div>
                                            <div class="col-6 col-sm-3 text-center d-flex justify-content-center align-items-center flex-column mb-4 mb-sm-0">
                                                <div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-3">
                                                    <i data-acorn-icon="arrow-top-right" class="text-white"></i>
                                                </div>
                                                <div class="text-small text-muted mb-1">ORDERS</div>
                                                <div class="cta-2 text-primary">421</div>
                                            </div>
                                            <div class="col-6 col-sm-3 text-center d-flex justify-content-center align-items-center flex-column mb-4 mb-sm-0">
                                                <div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-3">
                                                    <i data-acorn-icon="screen" class="text-white"></i>
                                                </div>
                                                <div class="text-small text-muted mb-1">VIEWS</div>
                                                <div class="cta-2 text-primary">752</div>
                                            </div>
                                            <div class="col-6 col-sm-3 text-center d-flex justify-content-center align-items-center flex-column mb-4 mb-sm-0">
                                                <div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-3">
                                                    <i data-acorn-icon="rotate-left" class="text-white"></i>
                                                </div>
                                                <div class="text-small text-muted mb-1">REFUNDS</div>
                                                <div class="cta-2 text-primary">53</div>
                                            </div>
