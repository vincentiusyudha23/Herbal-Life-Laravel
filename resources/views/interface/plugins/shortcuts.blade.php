...
@section('js_page')
    <script src="/js/plugins/shortcuts.js"></script>
@endsection
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card mb-5">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-outline-primary mb-1" id="button1">Primary</button>
                                        <button type="button" class="btn btn-outline-secondary mb-1" id="button2">Secondary</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card mb-5">
                                    <div class="card-body">
                                        <p>
                                            <kbd>ctrl+a</kbd>
                                            will add active class to the below items and will override default behaviour that selects all of the page.
                                        </p>
                                        <p>
                                            <kbd>ctrl+d</kbd>
                                            will remove active class from the below items and will override default behaviour that adds the page as a bookmark.
                                        </p>
                                        <div class="btn-group">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card mb-5">
                                    <div class="card-body">
                                        <p>
                                            <kbd>ctrl+s</kbd>
                                            will only work when cursor is in one of the inputs so the form is in focus. Will show spinner on the submit button for a second.
                                        </p>
                                        <form id="wrapperForm">
                                            <div class="mb-3">
