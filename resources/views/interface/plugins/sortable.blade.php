...
@section('js_page')
    <script src="/js/plugins/sortables.js"></script>
@endsection
                    ...
                    <section class="scroll-section" id="columns">
                        ...
                        <div class="row g-2 mb-5" id="sortableColumns">
                            <div class="col-3">
                                <div class="card sh-16">
                                    <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                        <i data-acorn-icon="pepper" class="text-primary mb-4"></i>
                            ...
                            <div class="col-3">
                                <div class="card sh-16">
                                    <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                        <i data-acorn-icon="pear" class="text-primary mb-4"></i>
                            ...
                            <div class="col-3">
                                <div class="card sh-16">
                                    <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                        <i data-acorn-icon="radish" class="text-primary mb-4"></i>
                            ...
                            <div class="col-3">
                                <div class="card sh-16">
                                    <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                                        <i data-acorn-icon="banana" class="text-primary mb-4"></i>
