            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Interface/Plugins/Datatables/BoxedVariations" class="heading stretched-link d-block">Boxed Variations</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Interface/Plugins/Datatables/EditableBoxed" class="heading stretched-link d-block">Editable Boxed</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Interface/Plugins/Datatables/EditableRows" class="heading stretched-link d-block">Editable Rows</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Interface/Plugins/Datatables/RowsAjax" class="heading stretched-link d-block">Rows Ajax</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body row gx-4">
                        ...
                        <div class="col">
                            <a href="/Interface/Plugins/Datatables/RowsServerSide" class="heading stretched-link d-block">Rows Server Side</a>
