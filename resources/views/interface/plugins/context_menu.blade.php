...
@section('js_page')
    <script src="/js/plugins/contextmenu.js"></script>
@endsection
                                ...
                                <div class="card mb-5 context-menu-icons" id="contextMenuBasic">
                                    <div class="row g-0 sh-9 p-card pt-0 pb-0">
                                        <div class="col-2 d-flex align-items-center justify-content-center">
                                            <div class="pe-card">
                                                <i data-acorn-icon="radio" class="text-primary"></i>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-4">
                                <div class="card mb-5" id="contextMenuIcons">
                                    <div class="row g-0 sh-9 p-card pt-0 pb-0">
                                        <div class="col-2 d-flex align-items-center justify-content-center">
                                            <div class="pe-card">
                                                <i data-acorn-icon="tool" class="text-primary"></i>
                                            </div>
                                        </div>
                                        <div class="col-10 d-flex flex-column justify-content-center">
                            ...
                            <div class="col-12 col-lg-6 col-xl-4">
                                <div class="card mb-5" id="contextMenuDisabledItem">
                                    <div class="row g-0 sh-9 p-card pt-0 pb-0">
                                        <div class="col-2 d-flex align-items-center justify-content-center">
                                            <div class="pe-card">
                                                <i data-acorn-icon="air-balloon" class="text-primary"></i>
                                            </div>
                                        </div>
                                        <div class="col-10 d-flex flex-column justify-content-center">
                            ...
                            <div class="col-12 col-lg-6 col-xl-4">
                                <div class="card mb-5" id="contextMenuHover">
                                    <div class="row g-0 sh-9 p-card pt-0 pb-0">
                                        <div class="col-2 d-flex align-items-center justify-content-center">
                                            <div class="pe-card">
                                                <i data-acorn-icon="toy" class="text-primary"></i>
                                            </div>
                                        </div>
                                        <div class="col-10 d-flex flex-column justify-content-center">
