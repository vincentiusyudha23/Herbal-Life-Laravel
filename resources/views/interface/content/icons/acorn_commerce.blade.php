@php
    $html_tag_data = [];
    $title = 'Acorn Commerce Icons';
    $description = 'Commerce and money icons created exclusively for Acorn ecommerce project.';
                    ...
                    <div class="card mb-2">
                        <div class="card-body text-center position-relative p-0">
                            <input
                                    ...
                                    id="acornCommerceIconsSearch"
                            />
                            <i data-acorn-icon="search" class="search-input-icon text-muted"></i>
                        </div>
                    </div>

                    <div class="row g-2 row-cols-3 row-cols-md-4 row-cols-lg-6" id="acornCommerceIconsContainer">
