                ...
                <div>
                    ...
                    <section class="scroll-section" id="colors">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Primary
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Success
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Info
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-warning dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Warning
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Danger
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-light dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Light
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-dark dropdown-toggle mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Dark
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-4 mb-md-0">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <div class="dropdown dropend dropdown-submenu">
                                                        <button class="dropdown-item dropdown-toggle" type="button">Action</button>
                                                        <div class="dropdown-menu">
                                        ...
                                        <div class="mb-1 btn-group">
                                            <div class="dropup">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" data-submenu="">Dropup</button>
                                                <div class="dropdown-menu">
                                                    <div class="dropdown dropend dropdown-submenu">
                                                        <button class="dropdown-item dropdown-toggle" type="button">Action</button>
                                                        <div class="dropdown-menu">
                                        ...
                                        <div class="mb-1 btn-group">
                                            <div class="btn-group dropup">
                                                ...
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" data-submenu=""></button>
                                                <div class="dropdown-menu">
                                                    <div class="dropdown dropend dropdown-submenu">
                                                        <button class="dropdown-item dropdown-toggle" type="button">Action</button>
                                                        <div class="dropdown-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-toolbar mb-2" role="toolbar">
                                    ...
                                    <div class="btn-group mb-1 ms-1">
                                        <button type="button" class="btn btn-xl btn-secondary">Xlarge split button</button>
                                        <button
                                                type="button"
                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    ...
                                    <div class="btn-group w-100">
                                        <button type="button" class="btn btn-secondary w-100">Block split button</button>
                                        <button
                                                type="button"
                                                ...
                                                <div class="row mb-1 ms-0 me-0">
                                                    ...
                                                    <div class="col-6 ps-1 pe-1">
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <a href="#">
                                                                    <i data-acorn-icon="help" data-acorn-size="17" class="me-2"></i>
                                                                    <span class="align-middle">Help</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    <i data-acorn-icon="file-text" data-acorn-size="17" class="me-2"></i>
                                                    ...
                                                    <div class="col-6 pe-1 ps-1">
                                                        <ul class="list-unstyled">
                                                            <li>
                                                                <a href="#">
                                                                    <i data-acorn-icon="gear" data-acorn-size="17" class="me-2"></i>
                                                                    <span class="align-middle">Settings</span>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    <i data-acorn-icon="logout" data-acorn-size="17" class="me-2"></i>
