            ...
            <div class="col">
                ...
                <div>
                    ...
                    <section class="scroll-section" id="customContent">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="toast fade show align-items-center mb-2" role="alert" aria-live="assertive" aria-atomic="true">
                                    <div class="d-flex">
                                        <div class="toast-body">Hello, world! This is a toast message.</div>
                    ...
                    <section class="scroll-section" id="colorSchemes">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                ...
                                <div class="toast align-items-center bg-secondary border-0 fade show mb-2" role="alert" aria-live="assertive" aria-atomic="true">
                                    <div class="d-flex">
                                        <div class="toast-body text-white">Hello, world! This is a toast message.</div>
                                        <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
                                    </div>
