                    ...
                    <section class="scroll-section" id="backgrounds">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                ...
                                <div class="progress progress-xl mb-2">
                                    <div class="progress-bar bg-tertiary" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="progress progress-xl mb-2">
                                    <div class="progress-bar bg-quaternary" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="progress progress-xl mb-2">
