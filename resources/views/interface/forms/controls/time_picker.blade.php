...
@section('js_page')
    <script src="/js/forms/controls.timepicker.js"></script>
@endsection
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-xl-4">
                                        <div class="time-picker-container">
                                            <label class="form-label">Time</label>
                                            <input class="form-control time-picker" name="time" data-format="12" id="timePicker12" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-xl-4">
                                        <div class="time-picker-container">
                                            <label class="form-label">Time</label>
                                            <input class="form-control time-picker" name="time" value="14:15" id="timePickerInitialValue" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-4">
                                        <div class="time-picker-container">
                                            ...
                                            <input
                                                    ...
                                                    name="time"
                                                    value="09:00"
                                                    data-hours24="9,10,11,12,13,14,15,16,17"
                                                    id="timePickerWorkHours"
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-xl-4">
                                        <div class="time-picker-container">
                                            ...
                                            <small class="form-text text-muted d-block">Logs date value in the console with every fire of update event.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-xl-4">
                                        <div class="time-picker-container">
                                            ...
                                            <small class="form-text text-muted d-block">Logs time as a date string in the console.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                ...
                                <div class="time-picker-container">
                                    <label class="form-label">Time</label>
                                    <div class="d-inline-block me-3">
                                        <input class="form-control time-picker" id="timeSet12Hour" data-classname="mb-1" data-format="12" />
                                    </div>
                                    <div class="d-inline-block">
                                        <button class="btn btn-outline-primary time-set-button-12Hour mb-1">09:00:AM</button>
                                        <button class="btn btn-outline-primary time-set-button-12Hour mb-1">09:00:PM</button>
                                    </div>
                                </div>
                            </div>
                        </div>
