                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            ...
                                            <div class="br-wrapper br-theme-cs-icon">
                                                <select name="rating" autocomplete="off" data-initial-rating="0" id="ratingCSIconInteractive">
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            ...
                                            <div class="br-wrapper br-theme-cs-icon">
                                                <select name="rating" autocomplete="off" data-readonly="true" data-initial-rating="4" id="ratingCSIconReadonly">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            <label class="d-block form-label">Readonly</label>
                                            <div class="br-wrapper br-theme-css-stars">
                                                <select name="rating" autocomplete="off" data-readonly="true" id="ratingCSSIconReadonly">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            <label class="d-block form-label">Interactive</label>
                                            <div class="br-wrapper br-theme-cs-icon">
                                                <select name="rating" autocomplete="off" id="ratingTenPointsInteractive">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            <label class="d-block form-label">Readonly</label>
                                            <div class="br-wrapper br-theme-cs-icon">
                                                <select name="rating" autocomplete="off" data-readonly="true" data-initial-rating="8" id="ratingTenPointsReadonly">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            <label class="d-block form-label">Readonly</label>
                                            <div class="br-wrapper br-theme-bars-low">
                                                <select name="rating" autocomplete="off" data-readonly="true" data-initial-rating="Magnificent" id="barsLowReadonly">
                                                    <option value="Bad">Bad</option>
                                                    <option value="Mediocre">Mediocre</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            <label class="d-block form-label">Readonly</label>
                                            <div class="br-wrapper br-theme-bars-tall">
                                                <select name="rating" autocomplete="off" data-readonly="true" id="barsTallReadonly">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                    ...
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        <div class="mb-1">
                                            ...
                                            <div class="br-wrapper br-theme-button">
                                                <select name="rating" autocomplete="off" data-show-values="true" data-show-selected-rating="false" id="ratingButtonInteractive">
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                                    <option value="4">4</option>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="br-wrapper br-theme-button">
                                                <select
                                                        name="rating"
                                                        autocomplete="off"
                                                        data-show-selected-rating="false"
                                                        data-show-values="true"
                                                        data-readonly="true"
                                                        id="ratingButtonReadonly"
                                                >
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                    ...
                    <section class="scroll-section" id="filled">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="filled custom-control-container rating-container d-flex align-items-center mb-0">
                                            <i data-acorn-icon="badge"></i>
                                            <div class="br-wrapper br-theme-cs-icon">
