                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="date-picker form-control" placeholder="Date" id="datePickerFloatingLabel" />
                                        <label>Date</label>
                                    </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <fieldset disabled>
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" placeholder="Email" value="support@crealeaf.com" disabled />
                                        </div>
                                    </fieldset>
                                </form>
                                <form>
                                ...
                                <form>
                                    <fieldset disabled>
                                        <div class="filled">
                                            <i data-acorn-icon="user"></i>
                                            <input class="form-control" placeholder="Email" value="support@crealeaf.com" disabled />
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
